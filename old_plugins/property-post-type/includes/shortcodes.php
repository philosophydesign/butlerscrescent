...
function property_func( $atts ) {
	...
	$args = array(
		'post_type' => 'property',
		'post_status' => array('publish','reserved'),
		'order' => 'ASC',
		'posts_per_page' => '-1',
		//'paged' => $paged
	);
	...
	while( $query->have_posts()) : $query->the_post();
		...
		switch ($post->post_status) {
			...
			case "reserved":
				$availability = '<font style="color:#E2804F">Reserved</font>';
				break;
...
function property_links_func( $atts ) {
	...
	if( $floorp_pdf ) $html.= '<br/><a target="_blank" href="'.$floorp_pdf['url'].'"><i class="vc_btn3-icon fa fa-chevron-down"></i> Download '.$floorp_pdf['title'].' ('.$floorp_pdf['size'].')</a>';
